...
<html lang="en">
<head>
    <title>Relaciones Seleccionadas</title>
    <meta charset="UTF-8">
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="text-center">
                    <h4 class="mb-0">Tablas relacionadas existentes</h4><br>
                    <fieldset>
                ...
                <div class="text-center">
                    <h4 class="mb-0">Agregar Relación de tablas</h4><br>
                      <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
<?php
...
?>
                       ...
                       <select name='onupdate' id='onupdate' style='max-width:15%'>";
                            ...
                            <option name="onupdate_restrict" value="restrict">On Update: Restrict</option>
                                ...
                                <button type="submit" id="singlebutton" name="addkey" class="btn btn-primary">Crear Relación</button>
                    </fieldset>
                </form>
            </div>
        </div>
...
<hr>
En esta página puede agregar relaciones de tabla nuevas o eliminar las existentes, es decir, claves externas. Tener claves externas dará como resultado formularios de Cruddiy con eliminaciones / actualizaciones en cascada y campos desplegables llenos de claves externas. Si no está claro lo que quiere o necesita hacer aquí, ¡es MÁS SEGURO omitir este paso y pasar al siguiente! Siempre puedes volver más tarde y regenerar nuevas formas.
<hr>
<form method="post" action="tables.php">
    <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-success">Continuar el CRUD</button>
</form>
</section>
