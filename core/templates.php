            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">{TABLE_DISPLAY} Detalles</h2>
                        <a href="{TABLE_NAME}-create.php" class="btn btn-success float-right">Agregar</a>
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    ...
                                    {INDEX_TABLE_ROWS}
                                        echo "<td>";
                                            ...
                                            echo "<a href='{TABLE_NAME}-update.php?{COLUMN_ID}=". $row['{COLUMN_NAME}'] ."' title='Editar' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='{TABLE_NAME}-delete.php?{COLUMN_ID}=". $row['{COLUMN_NAME}'] ."' title='Eliminar' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
...
if(isset($_GET["{TABLE_ID}"]) && !empty($_GET["{TABLE_ID}"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            echo "Oops! Algo salio mal. Por favor trata de nuevo.";
        }
    }
                ...
                <div class="col-md-6 mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        <div class="alert alert-danger fade-in">
                            ...
                            <p>Seguro que deseas Eliminar?</p><br>
                            <p>
                                <input type="submit" value="Si" class="btn btn-danger">
                                <a href="{TABLE_NAME}-index.php" class="btn btn-secondary">Nel</a>
                            </p>
                        </div>
                    </form>
                </div>
