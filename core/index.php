            ...
            <form class="form-group-row" action="relations.php" method="post" >
                <fieldset>
                    ...
                    <div class="text-center pt-5">
                        <h4>Informacón de la Base de Datos</h4>
                    </div>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                        <label class="col-form-label" for="textinput">Base de Datos</label>
                    ...
                    <!-- Password input-->
                    <div class="form-group">
                        <label class="col-form-label" for="passwordinput">Contraseña</label>
                    ...
                    <div class="form-group">
                        <label class="col-form-label" for="index"></label>
                            <button id="index" name="index" class="btn btn-primary">Entrar</button>
                    </div>
                </fieldset>
            </form>
        </div>
