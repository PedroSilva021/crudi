                    ...
                    <fieldset>
                            ...
                            foreach ( $_POST['table'] as $table )
                            {
                                ...
                                if (isset($table['tablecheckbox']) && $table['tablecheckbox'] == 1) {
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="textinput_'.$tablename. '"name="'. $tablename. 'columns['.$i.'][columndisplay]" type="text" placeholder="Nombre del campo en FrontEnd" class="form-control">
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-12 offset-5">
                                ...
                                <button type="submit" id="singlebutton" name="singlebutton" class="btn btn-primary">Generar paginas</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
